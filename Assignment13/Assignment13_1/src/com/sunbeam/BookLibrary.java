...
public class BookLibrary {
	...
	public static void saveBook(List<Book> lib) {
		try (FileOutputStream fout = new FileOutputStream("book.text")) {
	...
	public static void readBook() {
		try(FileInputStream fin = new FileInputStream("book.text")){
			try(DataInputStream din = new DataInputStream(fin)){
				while(true)
				{
					Book b11 = new Book();
					b11.setIsbn(din.readUTF());
					b11.setPrice(din.readDouble());
					b11.setAuthorName(din.readUTF());
					b11.setQuantity(din.readInt());
	...
	public static void main(String[] args) {
		...
		while (true) {
			...
			case 7: // Save books in ﬁle

				saveBook(lib);

				break;

			case 8: // load books from ﬁle
				readBook();
